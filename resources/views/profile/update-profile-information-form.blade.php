<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div x-data="{photoName: null, photoPreview: null}" class="col-6 ">
            ...
            <div class="mt-2" x-show="! photoPreview">
                <img src="{{ $this->user->profile_photo_url }}" alt="{{ $this->user->name }}"
                    class="rounded-circle object-cover" width="350" height="350">
            </div>
            ...
            <div class="mt-2" x-if="photoPreview">
                <img :src="photoPreview" alt="Preview" class="rounded-circle object-cover" width="350" height="350">
            </div>
    ...
    <x-slot name="actions">
        ...
        <x-button wire:loading.attr="disabled" class="mt-3" wire:target="photo">
            {{ __('Guardar') }}
        </x-button>
    </x-slot>
</x-form-section>
