            ...
            <div class="position-relative">
                <a href="{{route('inicio')}}">
                    <img src="{{ Storage::url('Logo.svg') }}" alt="El Rincón de las letras"
                        class="position-absolute top-3 start-10 d-none d-md-block img-fluid" width="100" height="100">
                </a>
            </div>
            <div class="row">
                    ...
                    <div class="row justify-content-center align-items-center d-flex vh-100">
                        <div class="col-md-8 justify-content-center align-items">
                            <a class="d-flex flex-column justify-content-center align-items-center"
                                href="{{route('inicio')}}">
                                <img src="{{ Storage::url('Logo.svg') }}" alt="El Rincón de las letras"
                                    class="position-absolute top-3 start-10 d-md-none d-sm-block img-fluid mt-5"
